  ...
  return (
    <div>
      <div className="modal-body">
        ...
        <div className="mb-3">
        <label for="formFile" className="form-label">Employee Profile Image</label>
        ...
        <div className="mb-3 w-50">
            <label for="Joining Date" className="form-label">Joining Date</label>
